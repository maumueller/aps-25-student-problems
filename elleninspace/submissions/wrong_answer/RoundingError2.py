#This will fail due to adding a too high uncertainty margin to the radius
import math
...
for point in focuspoints:
    ...
    for circle in projections:
        x2,y2,r = circle
        if(get2Ddist(x1,y1,x2,y2) <= r + 0.03): #This will fail due to a too large constant added to r
            intersections += 1
